                    ...
                    <div className="col-lg-12 mainHeader">
                        <div className="col-lg-12 questionPanel">
                            ...
                            <div className="col-lg-10 profileTitle">
                                <div className="profileName">{userData.owner.display_name}</div>
                                <div className="col-lg-12 profileSubTitle noPadding">
                                    <div className="socialLinks">
                                        <span>{userData.owner.website_url ? (userData.owner.website_url).replace("http://www.", "") : ""}</span>
                                        <span>{userData.owner.location}</span>
                                        <span>{moment(userData.owner.creation_date * 1000).fromNow()}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div className="col-lg-12 noPadding">
                                        <div className="col-lg-6 noPadding">
                                            <div className="col-lg-12 countBox">
                                                <div className="col-lg-12 noPadding countValue count">{userData.owner.reputation || 0}</div>
                                                <div className="col-lg-12 noPadding countTitle">reputation</div>
                                            </div>
                                        </div>
                                        <div className="col-lg-6 noPadding">
                                            <div className="col-lg-12 countBox">
                                                <div className="col-lg-12 noPadding countValue count">{userData.owner.accept_rate || 0}</div>
